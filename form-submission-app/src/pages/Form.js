    ...
    if(company.code === "xyz" || company.code === "abc" || company.code === "rnq")
        ...
        <div>
            <form className="dataForm" onSubmit={submitHandler}>
                ...
                {(!textIsValid && textWasTouched) && <p className="error">Treść zgłoszenia nie może być pusta</p>}
